...
namespace wwpcbot_v2.Layout
{
    class ChatLayout
    {
        ...
        public static void addToChatLayout()
        {
            ...
            if (Properties.Settings.Default.TwitchLayout == true && Functionality.info.display_name != null && IRCconnect._data.Contains("PRIVMSG"))
            {
            ...
            if (Properties.Settings.Default.TwitchEmotes == true && Functionality.info.emote_sets.Contains(':'))
            {
